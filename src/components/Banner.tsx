              ...
              <div className="flex items-center h-full">
                <div className="py-10">
                  <div className="space-y-8 px-4">
                    ...
                    <h1 className="text-5xl leading-tight roboto-regular tracking-wide py-2">
                      Hello! I'm John Lloyd Serrano
                    </h1>
                  </div>
                </div>
              </div>
            ...
            <div className="w-1/2 p-12">
              <div className="flex items-center flex-wrap h-full px-4 py-10 space-y-6">
                ...
                <p className="roboto-regular text-lg text-slate-500">
                  A passionate individual who finds deep fulfillment and joy in the journey of crafting meaningful
                  experiences.
                </p>
                <div className="space-x-6">
                  <button
                    className="roboto-medium text-lg bg-primary border border-primary tracking-wide text-white py-2 px-6 rounded-lg"
                  >
                    Talk with me
                  </button>
