    ...
    return (
        <section className="w-full bg-white py-6">
            <div className="container px-[7.5rem] py-6 mx-auto">
                ...
                >
                    <SectionHeader title={t(HOME.section.title.contact.text)} description={t(HOME.section.title.contact.desc)} />
                    <div className="px-4 py-6 flex flex-col gap-8 md:flex-row">
                                ...
                                <Form {...form}>
                                    <form onSubmit={form.handleSubmit(onSubmit)} className="py-6 pr-12 pb-16 space-y-6">
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder={t(HOME.section.form.contact.placeHolder.name)} className="quicksand-medium focus:ring-0 focus:border-primary active:bg-secondary border-t-0 border-x-0 rounded-none py-6 shadow-none" {...field} />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input placeholder={t(HOME.section.form.contact.placeHolder.email)} className="quicksand-medium focus:ring-0 focus:border-primary border-t-0 border-x-0 rounded-none py-6 shadow-none" type="email" {...field} />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Textarea placeholder={t(HOME.section.form.contact.placeHolder.message)} className="quicksand-medium focus:ring-0 focus:border-primary border-t-0 border-x-0 rounded-none py-6 shadow-none min-h-[120px]" {...field} />
                                                    </FormControl>
                                        ...
                                        <div className="absolute bottom-[-45px] w-full flex items-center py-6 justify-center">
                                            <Button className="w-1/5 relative overflow-hidden group" variant="primary">
                        ...
                        <div className="w-full md:w-[25%] flex flex-col justify-start mt-6 space-y-4">
                            <div className="h-1/3 w-full bg-card p-6 rounded-md border shadow-sm">
                            ...
                            <div className="h-[50%] w-full bg-card p-6 border rounded-md space-y-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
                                    ...
                                    <a
                                        href="#"
                                        className="flex items-center gap-2 text-muted-foreground hover:text-primary transition-colors col-span-2 md:col-span-1"
                                        aria-label="GitHub"
                                    >
